...
const newHomepageHeroCSS = `/* ========================================
   HERO ACCUEIL MODERNE - DESIGN 2024
   ======================================== */
...
console.log('🔧 Réparation du CSS de la page d\'accueil...\n');

const stylePath = path.join(__dirname, 'assets/css/style.css');
let content = fs.readFileSync(stylePath, 'utf-8');
const lines = content.split('\n');

// Trouver les lignes de début et fin du hero-adidas
const startLine = 1774; // ligne "/* ========================================"
const endLine = 2099;   // juste avant "/* === ANIMATION FLOTTEMENT"

// Garder tout avant le hero
const before = lines.slice(0, startLine).join('\n');

// Garder tout après le hero
const after = lines.slice(endLine).join('\n');

// Reconstruire le fichier
const newContent = before + '\n' + newHomepageHeroCSS + '\n' + after;

fs.writeFileSync(stylePath, newContent, 'utf-8');

console.log('✅ assets/css/style.css - Hero accueil modernisé');
console.log('✨ Nouveau design : gradient clair, formes animées, boutons modernes !');
